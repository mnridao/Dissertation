...
from pythonCode.analyticalSolutions import integrand4, analyticalSolution4
...
if __name__ == "__main__":
    ...
    u = 5.
    integrator = Trapezoidal(integrand4, solver.dt, solver.nt, 
                             args=(solver.model.grid.X, u, solver.model.params), 
                             store=False)
    
    solver.addCustomEquation("integrator", integrator, store=False)
    solver.addCustomEquation("analytic", analyticalSolution4, args=(solver,), store=False)
